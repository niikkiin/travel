...
// styled components
import { BusinessProfileAccountContainer } from 'pages/site/edit-profile/edit-profile.styles';
...
const EditProfilePage = ({ hidden, toggleChangeProfilePicture }) => {
	...
	const { avatarImg, firstName, lastName, email, businessName, website, address, phoneNumber } = formData;
	...
	return (
		<BusinessProfileAccountContainer>
			...
			<ShowHideContainer doShow={hidden}>
				<ChangeProfile avatar={avatar} formData={formData} setAvatar={setAvatar} setFormData={setFormData} />
			</ShowHideContainer>
...
export default connect(mapStateToProps, { toggleChangeProfilePicture })(EditProfilePage);
